...
//task 21
console.log(`task 21: the product of the array of numbers ${numbers} is ${numbers.reduce(getProduct, 1)}`);
...
console.log(`task 22: the sqrs is ${sqrs}`);

//task 23
let words = [`hello`, `worlds`, `lirazing`, `abc`, `abcdefghijklmnopqrstuvxyz`];
let longWords = words.filter(longWord);
console.log(`task 23: words are ${words}, the long words are ${longWords}`);

//task 24
console.log(`task 24: ${colors} contain "purple" - ${colors.includes(`purple`)}`);
